...
public class MatrixArrayListTest {
	...
	public void test_mult_matrix_associative() {
		...
		Matrix a = new MatrixArrayList(dim, dim);
		Matrix b = new MatrixArrayList(dim, dim);
		Matrix c = new MatrixArrayList(dim, dim);
	...
	public void test_mult_matrix_identity() {
		...
		Matrix a = new MatrixArrayList(dim, dim);
		Matrix identity_matrix = new MatrixArrayList(dim, dim);
	...
	public void test_pow() {
		int dim = 3;
		Matrix m1 = new MatrixArrayList(dim, dim);
		Matrix m2 = new MatrixArrayList(dim, dim);
		Matrix m3 = new MatrixArrayList(dim, dim);
