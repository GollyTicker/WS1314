...
public class Hierholzer {
	...
	// Voraussetzung: Sei G=(V,E) ein zusammenhängender Graph, der nur Knoten
	// mit geradem Grad aufweist.
	// 1. Wähle einen beliebigen Knoten v_0 des Graphen und konstruiere von v_0
	// ausgehend einen
	...
	// 4. Am ersten Eckpunkt von K, dessen Grad größer 0 ist, lässt man nun
	// einen weiteren Unterkreis K'
	// entstehen, der keine Kante in K durchläuft und keine Kante in G zweimal
	// enthält.
	// 5. Füge in K den zweiten Kreis K' ein, indem der Startpunkt von K' durch
	// alle Punkte von K'
